...
[![App Version](https://img.shields.io/static/v1?label=App+Version&message=2026.5.18&color=blue)](https://github.com/openclaw/openclaw)
[![Chart Version](https://img.shields.io/badge/Chart_Version-1.5.37-blue)](https://github.com/serhanekicii/openclaw-helm)
...
| app-template.openclawVersion | string | `"2026.5.18"` | OpenClaw image version (used by all OpenClaw containers) |
